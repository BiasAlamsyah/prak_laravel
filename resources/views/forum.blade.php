...
<form id="logout-form" action="{{ route('user.logout') }}" method="POST" style="display: none;">
    ...
    <div class="cbox">
    	<div class="chat">
    	<script id="cid0020000172122733430" data-cfasync="false" async src="//st.chatango.com/js/gz/emb.js" style="width: 100%;height: 100%;">{"handle":"gandool21","arch":"js","styles":{"a":"0084ef","b":100,"c":"FFFFFF","d":"FFFFFF","k":"0084ef","l":"0084ef","m":"0084ef","n":"FFFFFF","p":"10","q":"0084ef","r":100,"usricon":1.18,"fwtickm":1}}</script>
    	</div>
	</div>
